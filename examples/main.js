...
var $author$project$Main$Yoga = {$: 'Yoga'};
var $author$project$Main$activitySynonyms = _List_fromArray(
	[
		_Utils_Tuple2(
		$author$project$Main$Cycling,
		_List_fromArray(
			['bike', 'biking', 'biked', 'cycle', 'cycling', 'cycled', 'rode', 'riding'])),
		_Utils_Tuple2(
		...
		_Utils_Tuple2(
		$author$project$Main$Yoga,
		_List_fromArray(
			['yoga']))
	]);
var $author$project$Nld$Done = F3(
	function (a, b, c) {
		return {$: 'Done', a: a, b: b, c: c};
	});
var $author$project$Nld$More = F2(
	function (a, b) {
		return {$: 'More', a: a, b: b};
	});
var $author$project$Peach$Peach = function (a) {
	return {$: 'Peach', a: a};
};
...
var $author$project$Peach$itemWeight = function (item) {
	if (item.$ === 'Value') {
		var w = item.a;
		return w;
	} else {
...
var $author$project$Peach$heapOptions = A2($TSFoster$elm_heap$Heap$by, $author$project$Peach$itemWeight, $TSFoster$elm_heap$Heap$smallest);
var $author$project$Peach$emptyHeap = $TSFoster$elm_heap$Heap$empty($author$project$Peach$heapOptions);
...
var $TSFoster$elm_heap$Heap$toListReverse = function () {
	var toListHelper = F2(
		function (popped, heap) {
			toListHelper:
			while (true) {
				var _v0 = $TSFoster$elm_heap$Heap$pop(heap);
				if (_v0.$ === 'Nothing') {
					return popped;
				} else {
					var _v1 = _v0.a;
					var el = _v1.a;
					var subheap = _v1.b;
					var $temp$popped = A2($elm$core$List$cons, el, popped),
						$temp$heap = subheap;
					popped = $temp$popped;
					heap = $temp$heap;
					continue toListHelper;
				}
			}
		});
	return toListHelper(_List_Nil);
}();
var $TSFoster$elm_heap$Heap$toList = A2($elm$core$Basics$composeL, $elm$core$List$reverse, $TSFoster$elm_heap$Heap$toListReverse);
var $author$project$Peach$choose = function (peaches) {
	var combineHeaps = F2(
		function (_v0, acc) {
			var heap = _v0.a;
			return A3(
				...
				acc,
				$TSFoster$elm_heap$Heap$toList(heap));
		});
	return $author$project$Peach$Peach(
		A3($elm$core$List$foldl, combineHeaps, $author$project$Peach$emptyHeap, peaches));
};
...
var $author$project$Nld$getWanted = function (nld) {
	if (nld.$ === 'Done') {
...
var $author$project$Peach$Thunk = F2(
	function (a, b) {
		return {$: 'Thunk', a: a, b: b};
	});
var $author$project$Peach$Value = F2(
	function (a, b) {
...
var $author$project$Peach$map = F2(
	function (f, _v0) {
		var heap = _v0.a;
		...
		return $author$project$Peach$Peach(
			A2(
				...
				A2($TSFoster$elm_heap$Heap$by, $author$project$Peach$itemWeight, $TSFoster$elm_heap$Heap$smallest),
				A2(
					$elm$core$List$map,
					mapItem,
					$TSFoster$elm_heap$Heap$toList(heap))));
	});
var $author$project$Peach$flatMap = F2(
	function (f, _v0) {
		var heap = _v0.a;
		var addWeight = F2(
			function (extraWeight, _v6) {
				var h = _v6.a;
				return $author$project$Peach$Peach(
					A2(
						$TSFoster$elm_heap$Heap$fromList,
						...
						A2(
							$elm$core$List$map,
							addWeightToItem(extraWeight),
							$TSFoster$elm_heap$Heap$toList(h))));
			});
		var addWeightToItem = F2(
			function (extraWeight, item) {
				if (item.$ === 'Value') {
					var w = item.a;
					var b = item.b;
					return A2($author$project$Peach$Value, w + extraWeight, b);
				} else {
					var w = item.a;
					var thunk = item.b;
					return A2(
...
var $author$project$Peach$peach = function (weightedValues) {
	return $author$project$Peach$Peach(
		A2(
			$TSFoster$elm_heap$Heap$fromList,
			$author$project$Peach$heapOptions,
			A2(
				$elm$core$List$map,
				function (_v0) {
					var w = _v0.a;
					var a = _v0.b;
					return A2($author$project$Peach$Value, w, a);
				},
				weightedValues)));
};
var $author$project$Nld$runHelper = F3(
	function (nld, tp, lastPos) {
		if (nld.$ === 'Done') {
			var a = nld.a;
			return $author$project$Peach$peach(
				_List_fromArray(
			...
			return A2(
				$author$project$Peach$flatMap,
				function (nld2) {
					return A3($author$project$Nld$runHelper, nld2, tp, lastPos);
				},
				A2(k, tp, lastPos));
		}
	});
...
var $author$project$Nld$choice = function (parsers) {
	var k = F2(
		function (tp, lastPos) {
			return A2(
				$author$project$Peach$map,
				function (a) {
					return A3($author$project$Nld$Done, a, tp, lastPos);
				},
				$author$project$Peach$choose(
					A2(
						$elm$core$List$map,
						function (nld) {
							return A3($author$project$Nld$runHelper, nld, tp, lastPos);
						},
						parsers)));
		});
	var allWanted = A3(
		...
		$elm$core$Set$union,
		$elm$core$Set$empty,
		A2($elm$core$List$map, $author$project$Nld$getWanted, parsers));
	return A2($author$project$Nld$More, allWanted, k);
};
var $author$project$Nld$map = F2(
	function (f, nld) {
		if (nld.$ === 'Done') {
			var a = nld.a;
			var rem = nld.b;
			...
			return A2(
				...
				wanted,
				F2(
					function (rem, lastPos) {
						return A2(
							$author$project$Peach$map,
							$author$project$Nld$map(f),
							A2(k, rem, lastPos));
					}));
		}
	});
...
var $author$project$Peach$fail = $author$project$Peach$Peach($author$project$Peach$emptyHeap);
...
var $author$project$Nld$gapCost = F2(
	function (prevPos, currentPos) {
		return (_Utils_cmp(currentPos, prevPos) > -1) ? (currentPos - prevPos) : (1.5 * ((prevPos - currentPos) + 1));
	});
...
var $author$project$Nld$positions = F2(
	function (t, tp) {
		return A2(
			$elm$core$Maybe$withDefault,
			$elm$core$Set$empty,
			A2($elm$core$Dict$get, t, tp.toMap));
	});
...
var $author$project$Nld$remove = F3(
	function (t, pos, tp) {
		var newPosToText = A2($elm$core$Dict$remove, pos, tp.byPosition);
		var delPos = $elm$core$Maybe$map(
			$elm$core$Set$remove(pos));
		var newTextToPos = A3($elm$core$Dict$update, t, delPos, tp.toMap);
		return {byPosition: newPosToText, toMap: newTextToPos};
	});
var $author$project$Nld$words = function (wordList) {
	if (!wordList.b) {
		return A2(
			$author$project$Nld$More,
			$elm$core$Set$empty,
			F2(
				function (_v1, _v2) {
					return $author$project$Peach$fail;
				}));
	} else {
		var first = wordList.a;
		var k = F2(
			function (tp, lastPos) {
				var allPositions = A2(
					...
					function (w) {
						return A2(
							$elm$core$List$map,
							function (p) {
								return _Utils_Tuple2(w, p);
							},
							$elm$core$Set$toList(
								A2($author$project$Nld$positions, w, tp)));
					},
					wordList);
							...
							A2(
								...
								$elm$core$List$head(
									A2(
										...
										function (_v5) {
											var word_ = _v5.b;
											return _Utils_eq(word_, w);
										},
										A2($elm$core$List$indexedMap, $elm$core$Tuple$pair, wordList)))));
						return _Utils_Tuple2(
							A2($author$project$Nld$gapCost, lastPos, p) + wordPenalty,
							_Utils_Tuple2(w, p));
					},
					allPositions);
				return $elm$core$List$isEmpty(weightedPositions) ? $author$project$Peach$fail : A2(
					...
					function (_v3) {
						...
						return A3(
							$author$project$Nld$Done,
							first,
							A3($author$project$Nld$remove, w, p, tp),
							p);
					},
					$author$project$Peach$peach(weightedPositions));
			});
		var allWords = $elm$core$Set$fromList(wordList);
		return A2($author$project$Nld$More, allWords, k);
	}
};
var $author$project$Main$activityParser = $author$project$Nld$choice(
	A2(
		$elm$core$List$map,
		function (_v0) {
			var activity = _v0.a;
			...
			return A2(
				...
				$author$project$Nld$words(syns));
		},
		$author$project$Main$activitySynonyms));
var $author$project$Nld$andThen = F2(
	function (f, nld) {
		if (nld.$ === 'Done') {
			var a = nld.a;
			var tp = nld.b;
			...
			if (_v1.$ === 'Done') {
				var b = _v1.a;
				return A3($author$project$Nld$Done, b, tp, lastPos);
			} else {
				var wanted = _v1.a;
				var k = _v1.b;
				return A2($author$project$Nld$More, wanted, k);
			}
		} else {
			var wanted = nld.a;
			var k = nld.b;
			return A2(
				...
				F2(
					function (tp, lastPos) {
						return A2(
							$author$project$Peach$map,
							$author$project$Nld$andThen(f),
							A2(k, tp, lastPos));
					}));
		}
	});
var $author$project$Nld$map2 = F3(
	function (f, nldA, nldB) {
		return A2(
...
var $author$project$Nld$indexedWord = function (w) {
	var k = F2(
		function (remaining, prevPos) {
			var posSet = A2($author$project$Nld$positions, w, remaining);
			if ($elm$core$Set$isEmpty(posSet)) {
				return $author$project$Peach$fail;
			} else {
				var posList = $elm$core$Set$toList(posSet);
				var weightedPositions = A2(
					$elm$core$List$map,
					function (p) {
						return _Utils_Tuple2(
							A2($author$project$Nld$gapCost, prevPos, p),
							p);
					},
					posList);
				return A2(
					...
					function (pos_) {
						return A3(
							$author$project$Nld$Done,
							_Utils_Tuple2(w, pos_),
							A3($author$project$Nld$remove, w, pos_, remaining),
							pos_);
					},
					$author$project$Peach$peach(weightedPositions));
			}
	...
	return A2(
		$author$project$Nld$More,
		$elm$core$Set$singleton(w),
		k);
};
var $author$project$Nld$word = function (w) {
	return A2(
		$author$project$Nld$map,
...
var $author$project$Peach$take = F2(
	function (n, _v0) {
		var initialHeap = _v0.a;
		var go = F3(
			function (remaining, heap, acc) {
				go:
				while (true) {
					if (remaining <= 0) {
						return $elm$core$List$reverse(acc);
					} else {
						var _v1 = $TSFoster$elm_heap$Heap$pop(heap);
						if (_v1.$ === 'Nothing') {
							return $elm$core$List$reverse(acc);
						} else {
							var _v2 = _v1.a;
							...
							if (item.$ === 'Value') {
								...
								var thunk = item.b;
								var _v4 = thunk(_Utils_Tuple0);
								var thunkHeap = _v4.a;
								var mergedHeap = A3(
									$elm$core$List$foldl,
									$TSFoster$elm_heap$Heap$push,
									rest,
									$TSFoster$elm_heap$Heap$toList(thunkHeap));
								var $temp$remaining = remaining,
									$temp$heap = mergedHeap,
									$temp$acc = acc;
								remaining = $temp$remaining;
								heap = $temp$heap;
								acc = $temp$acc;
		...
		return A3(go, n, initialHeap, _List_Nil);
	});
var $author$project$Nld$tokenPositionsFromList = function (tokens) {
	var indexed = A2($elm$core$List$indexedMap, $elm$core$Tuple$pair, tokens);
	var toMap = A3(
		$elm$core$List$foldl,
		F2(
			function (_v1, acc) {
	...
	var byPosition = A3(
		...
		F2(
			function (_v0, acc) {
				var i = _v0.a;
				var t = _v0.b;
				return A3($elm$core$Dict$insert, i, t, acc);
			}),
		$elm$core$Dict$empty,
		indexed);
	return {byPosition: byPosition, toMap: toMap};
};
var $author$project$Nld$runTake = F3(
	function (n, nld, tokens) {
		return A2(
			$elm$core$List$map,
			$elm$core$Tuple$second,
			A2(
				$author$project$Peach$take,
				n,
				A3(
					$author$project$Nld$runHelper,
					nld,
...
var $author$project$Main$viewActivity = function (activity) {
	switch (activity.$) {
		case 'Cycling':
			return $elm$html$Html$text('🚴 Cycling');
		case 'Swimming':
			return $elm$html$Html$text('🏊 Swimming');
		case 'Running':
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$text('Parse from input')
							])),
						A2(
						$elm$html$Html$p,
						_List_Nil,
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$for('activity-input')
									]),
								_List_fromArray(
									[
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$id('activity-input'),
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$for('best-output')
									]),
								_List_fromArray(
									[
										$elm$html$Html$text('Best match')
									])),
								A3(
								$elm$html$Html$node,
								'output',
								_List_fromArray(
									[
										$elm$html$Html$Attributes$id('best-output'),
										A2($elm$html$Html$Attributes$attribute, 'for', 'activity-input'),
	...
	A2(
		...
		function (year) {
			return A2(
							...
							return A2(
								...
								function (dayOfYear) {
									return $elm$json$Json$Decode$succeed(
										{dayOfYear: dayOfYear, hour: hour, minute: minute, year: year});
								},
				...
				A2($elm$json$Json$Decode$field, 'minute', $elm$json$Json$Decode$int));
		},
